 ...
 * @author fikri
 */
public class SimpleCalculatorJavaSwing extends javax.swing.JFrame {

    /**
     * Creates new form kalkulatorvclass
     */
    double num, ans;
    int calculation;
    
    public SimpleCalculatorJavaSwing() {
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("Kalkulator by Fikri Syahfalaq");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SimpleCalculatorJavaSwing.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SimpleCalculatorJavaSwing().setVisible(true);
            }
        });
    }
